...
def generate_launch_description():
    ...
    default_params_file = os.path.join(get_package_share_directory(package_name),
    ...
    # 2. Integrated Bridge Node (Replaces the manual terminal command)
    # This maps the Ignition/GZ 'scan' topic to the ROS 2 '/scan' topic
    ros_gz_bridge = Node(
        ...
        remappings=[
            # This forces the scan to use the simple frame name
            ('/scan', '/scan'),
        ],
